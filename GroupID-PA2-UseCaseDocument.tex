...
% ------------ TRANG BÌA -------------
\input{sections/cover-use-case.tex}
...
% Tóm tắt các use case đã xác định cho từng giải pháp
% So sánh ngắn gọn giữa các giải pháp
% Kết luận về hướng phát triển tiếp theo
